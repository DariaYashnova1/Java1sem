...
rand_(P) :- int_max_(M), rand_int(M, P).
...
split_(	node((NodeKey, NodeValue, NodePrior), 
						NodeChildLeft, 
						NodeChildRight), 
				Key, 
				Left,
    		node((NodeKey, NodeValue, NodePrior), 
    				NewLeft, 
    				NodeChildRight)) :-
    Key =< NodeKey, !,
...
merge_(	node((LeftNodeKey, LeftNodeValue, LeftNodePrior), 
						LeftNodeChildLeft, 
						LeftNodeChildRight),
    		node((RightNodeKey, RightNodeValue, RightNodePrior), 
    				RightNodeChildLeft, 
    				RightNodeChildRight),
    		node((LeftNodeKey, LeftNodeValue, LeftNodePrior), 
    				LeftNodeChildLeft, 
    				NewRight)) :-
...
map_insert_(node((NodeKey, NodeValue, NodePrior), 
								NodeChildLeft, 
								NodeChildRigth), 
						(NewKey, NewValue, NewPrior),
    				node((NewKey, NewValue, NewPrior), 
    						NewChildLeft, 
    						NewChildRight)) :-
    NewPrior > NodePrior,
    split_(	node((NodeKey, NodeValue, NodePrior), 
...
map_insert_(node((NodeKey, NodeValue, NodePrior), 
    ...
    NewPrior =< NodePrior,
    NewKey < NodeKey, 
    map_insert_(NodeChildLeft, (NewKey, NewValue, NewPrior), NewChildLeft).
...
map_remove(	node((NodeKey, NodeValue, NodePrior), 
								NodeChildLeft, 
								NodeChildRight), 
						Key,
           	node((NodeKey, NodeValue, NodePrior), 
...
map_get(node((NodeKey, NodeValue, NodePrior), 
						NodeChildLeft, 
						NodeChildRight), 
				NodeKey, 
				NodeValue) :- !.
...
floorKey_(node((NodeKey, NodePrior, NodeValue), 
							NodeChildLeft, 
							NodeChildRight), 
					NodeKey, 
					NodeKey) :- !.
...
map_floorKey(	node((NodeKey, NodePrior, NodeValue), 
									NodeLeftChild, 
									NodeRightChild), 
							NewKey, 
							Res) :-
